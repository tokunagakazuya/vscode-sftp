...
const jestConfig = {
    ...
    verbose: true,
    colors: false,
    reporters: // used with FORCE_COLORS="true", restore the "normal" colors in Debug Console
        [
            '<rootDir>/test/jest-restore-colors-verbose-reporter.ts',
            "<rootDir>/test/jest-restore-colors-summary-reporter.ts"
        ],
